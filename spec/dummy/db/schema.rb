...
ActiveRecord::Schema[8.1].define(version: 2026_03_12_100827) do
  ...
  create_table "standard_id_consent_grants", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["account_id", "client_application_id"], name: "idx_consent_grants_active_unique", unique: true, where: "revoked_at IS NULL"
    t.index ["account_id"], name: "index_standard_id_consent_grants_on_account_id"
    t.index ["client_application_id"], name: "index_standard_id_consent_grants_on_client_application_id"
  end

  create_table "standard_id_credentials", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "credentialable_id", null: false
  ...
  create_table "standard_id_revoked_tokens", force: :cascade do |t|
    t.string "client_id"
    t.datetime "created_at", null: false
    t.datetime "expires_at", null: false
    ...
    t.string "token_type"
    t.datetime "updated_at", null: false
    t.index ["expires_at"], name: "index_standard_id_revoked_tokens_on_expires_at"
    t.index ["jti"], name: "index_standard_id_revoked_tokens_on_jti", unique: true
  end
